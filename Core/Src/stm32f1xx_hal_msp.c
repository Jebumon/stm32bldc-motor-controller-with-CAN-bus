...
void HAL_ADC_MspInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    GPIO_InitStruct.Pin = LoadCurrent_Pin|V_Batt_Pin|ChargingCurrent_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = V_Charger_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    HAL_GPIO_Init(V_Charger_GPIO_Port, &GPIO_InitStruct);
...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PB1     ------> ADC1_IN9
    */
    HAL_GPIO_DeInit(GPIOA, LoadCurrent_Pin|V_Batt_Pin|ChargingCurrent_Pin);

    HAL_GPIO_DeInit(V_Charger_GPIO_Port, V_Charger_Pin);
...
void HAL_TIM_Base_MspInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspInit 0 */
    ...
    */
    ...
    hdma_tim1_ch3.Init.PeriphInc = DMA_PINC_ENABLE;
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  /* USER CODE END TIM3_MspPostInit 0 */
    ...
    */
    ...
    GPIO_InitStruct.Pin = IndicatorLEDs_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    HAL_GPIO_Init(IndicatorLEDs_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  /* USER CODE END TIM1_MspDeInit 0 */
    ...
    PA10     ------> TIM1_CH3
    */
    HAL_GPIO_DeInit(GPIOB, GPIO_PIN_12|Phase_U_L_Pin|Phase_V_L_Pin|Phase_W_L_Pin);

    HAL_GPIO_DeInit(GPIOA, Phase_U_H_Pin|Phase_V_H_Pin|Phase_W_H_Pin);
